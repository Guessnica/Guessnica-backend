...
namespace Guessnica_backend.Migrations
{
    ...
    [Migration("20260106103636_AddUserAvatarAndCreateDate")]
    partial class AddUserAvatarAndCreateDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Guessnica_backend.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Guessnica_backend.Models.UserRiddle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Guessnica_backend.Models.UserVerificationCode", b =>
                {
                    ...
                    b.Property<Guid?>("ResetSessionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Guessnica_backend.Models.UserRiddle", b =>
                {
                    b.HasOne("Guessnica_backend.Models.Riddle", "Riddle")
                        .WithMany()
                        .HasForeignKey("RiddleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Guessnica_backend.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Guessnica_backend.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
